...
void main()
{
    ...
    if (u_TexMode != 0)
    {
		...
		if (Tex.x > 0.89)
		{
			texColor = texture( myTextureSampler9, vs_UV );
		}
		else if (Tex.x > 0.79)
		{
			texColor = texture( myTextureSampler8, vs_UV );
		}
		else if (Tex.x > 0.69)
		{
			texColor = texture( myTextureSampler7, vs_UV );
		}
		else if (Tex.x > 0.59)
		{
			texColor = texture( myTextureSampler6, vs_UV );
		}
		else if (Tex.x > 0.49)
		{
			texColor = texture( myTextureSampler5, vs_UV );
		}
		else if (Tex.x > 0.39)
		{
			texColor = texture( myTextureSampler4, vs_UV );
		}
		else if (Tex.x > 0.29)
		{
			texColor = texture( myTextureSampler3, vs_UV );
		}
		else if (Tex.x > 0.19)
		{
			texColor = texture( myTextureSampler2, vs_UV );
		}
		else if (Tex.x > 0.09)
		{
			texColor = texture( myTextureSampler1, vs_UV );
		}
